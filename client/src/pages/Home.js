...
function Home() {
  ...
  return (
    <div>
      ...
      <br></br>
      <Calendar
        onClickDay={() => setModalIsOpen(true)}
        maxDate={new Date(new Date().setDate(new Date().getDate() + 27))}
      />
      <Modal
        isOpen={modalIsOpen}
